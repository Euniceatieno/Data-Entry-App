# Generated by Django 4.1.6 on 2023-02-15 09:13
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            name='Event',
            fields=[
                ('basemodel_ptr', models.OneToOneField(auto_created=True, on_delete=django.db.models.deletion.CASCADE, parent_link=True, primary_key=True, serialize=False, to='data_entry_app.basemodel')),
                ('event_name', models.CharField(max_length=30, unique=True)),
                ('location', models.CharField(max_length=30)),
                ('description', models.TextField()),
                ('event_date', models.DateTimeField()),
            ],
            bases=('data_entry_app.basemodel',),
        ),
        migrations.CreateModel(
